...
int main( int argc, char *argv[ ] ) {
	...
	*/
	...
	for( int t = 0; t < NUMSTEPS; t++ ) {
		//COURSE-GRAINED PARALLELISM, follow these steps:
		// 1. uncomment the following line and comment line 71
		...
		for( int i = 0; i < NUMBODIES; i++ ) {
			...
			//FINE-GRAINED PARALLELISM - uncomment the following line and comment line 61
	...
	float megaBodies = ((float)(NUMBODIES * NUMBODIES * NUMSTEPS) /
		(time1 - time0) / 1000000.);
	printf("Performance: %8.4lf MegaBodies per sec\n", megaBodies);
